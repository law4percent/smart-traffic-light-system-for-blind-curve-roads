...
def main(video_source, weight_file_path: str, class_list_file_path: str, zones_file_path: str, detect_sensivity: float, time_interval: float, frame_name: str, frame_height: int, frame_width: int, wait_key: int, ord_key: str):
